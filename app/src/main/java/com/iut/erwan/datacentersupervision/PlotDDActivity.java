 ...
 */
public class PlotDDActivity extends Activity {

    private String LISTE_DD_KEY;
    private XYPlot plot;
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        final ArrayList<Integer> param_recu = intent.getIntegerArrayListExtra(StatsDDActivity.PARAM_SOURCE);
